...
public:
    ...
    {
        //return &m_mView;
		D3DXMatrixTranslation(&m_mShift, m_vMyKeyboardDirection.x, m_vMyKeyboardDirection.y, 0.0);
		D3DXMatrixMultiply(&m_mShift, &m_mView, &m_mShift);
		return &m_mShift;
    }
    ...
    {
		D3DXMATRIX viewInv;
		D3DXMatrixInverse(&viewInv, NULL, GetViewMatrix());
		D3DXVECTOR3 eyeview(0.0f, 0.0f, 0.0f);
		D3DXVec3TransformCoord(&m_vEyeShift, &eyeview, &viewInv);
		return &m_vEyeShift;

       // return &m_vEye;
    }
	D3DXVECTOR3* GetEyePtOrig()
    {
       return &m_vEye;
    }
	const D3DXVECTOR3* GetKeyboardVec() const {
		return &m_vMyKeyboardDirection;
	}
	void SetKeyboardVec(D3DXVECTOR3& keyVec) {
		m_vMyKeyboardDirection = keyVec;
	}
...
protected:
	...
	D3DXVECTOR3 m_vMyKeyboardDirection;
	...
	D3DXVECTOR3 m_vEyeShift;			// Camera eye after shift
